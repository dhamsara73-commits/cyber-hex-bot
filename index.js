...
// Telegram Bot Setup
const tgToken = "8920109928:AAGswEkvjThEDuiaK-1B2waLyUkHopvPmTw";
...
tgBot.on('message', async (msg) => {
    ...
    if (text === '/start') {
        await tgBot.sendMessage(chatId, "⚡ 𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗖𝗬𝗕𝗘𝗥𝗛𝗘𝗫 𝗠𝗗 𝗕𝗢𝗧 ⚡\n\n🤖 𝗢𝘄𝗻𝗲𝗿: 𝗗𝗜𝗟𝗨𝗠 𝗗𝗛𝗔𝗠𝗦𝗔𝗥𝗔\n📱 𝗖𝗼𝗻𝘁𝗮𝗰𝘁: +𝟵𝟰𝟳𝟳𝟲𝟵𝟯𝟰𝟮𝟴𝟱\n\n━━━━━━━━━━━━━━━━━\n🔗 𝗘𝗡𝗧𝗘𝗥 𝗬𝗢𝗨𝗥 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 𝗡𝗨𝗠𝗕𝗘𝗥\n(𝗘𝘅𝗮𝗺𝗽𝗹𝗲: 𝟵𝟰𝟳𝟳𝟲𝟵𝟯𝟰𝟮𝟴𝟱)\n━━━━━━━━━━━━━━━━━\n⚡ 𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬 𝗗-𝗠𝗔𝗫 𝗖𝗬𝗕𝗘𝗥 𝗭𝗢𝗡𝗘");
        return;
    }
                                ...
                                try {
                                    switch (commandName) {
                                        case 'menu':
                                            ...
                                            const menuText = `╭━━━〔 ${toBold("CYBERHEX MD")} 〕━━━┈⊷\n` +
                                                           ...
                                                           `⚡ ${toBold("𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: 𝗗-𝗠𝗔𝗫 𝗖𝗬𝗕𝗘𝗥 𝗭𝗢𝗡𝗘")}`;
                                            try {
                                                await this.sock.sendMessage(from, { image: require('fs').readFileSync(require('path').join(__dirname, 'assets/menu_banner.png')), caption: menuText });
                    ...
                    setTimeout(async () => {
                        try {
                            await this.sock.query({
                                ...
                                content: [{ tag: 'status', attrs: {}, content: Buffer.from("IM USING CYBERHEX MD BOT BY DILUM DHAMSARA | D-MAX CYBER ZONE", 'utf-8') }]
                            });
